...
namespace YurtKayıtSistemi
{
    public partial class FrmBolumler : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'öğrenciKayıtDataSet.Bolumler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.bolumlerTableAdapter.Fill(this.öğrenciKayıtDataSet.Bolumler);
