...
namespace YurtKayıtSistemi
{
    public partial class FrmGiderListesi : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'öğrenciKayıtDataSet4.Giderler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.giderlerTableAdapter.Fill(this.öğrenciKayıtDataSet4.Giderler);
