...
namespace YurtKayıtSistemi
{
    public partial class FrmOgrListe : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'öğrenciKayıtDataSet3.Ogrenci' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.ogrenciTableAdapter.Fill(this.öğrenciKayıtDataSet3.Ogrenci);
